    ...
    const onPick = async (ev) => {
      ...
      try {
        if (USE_CATCH_FETCH) {
          ...
          markCaught(seq);
          collectedCnt += 1;
          handleCollect(plane, `${lang_COLLECTION_COMPLETE}<br>${lang_COLLECTION_COMPLETE2}`, seq);
...
function setAuthModalText(type) {
  ...
  /* el_b1.style.display = el_b1.innerHTML ? "" : "none";
      	  el_b2.style.display = el_b2.innerHTML ? "" : "none";
      	  el_b3.style.display = el_b3.innerHTML ? "" : "none";

      	  el_p1.style.display = el_p1.innerHTML ? "" : "none";
      	  el_p2.style.display = el_p2.innerHTML ? "" : "none";
      	  el_p3.style.display = el_p3.innerHTML ? "" : "none";*/
